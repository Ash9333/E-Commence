    ...
    <div class="product-detail-info">
        ...
        <div class="categories" style="margin: 15px 0;">
            <?php while ($cat = $product_categories->fetch_assoc()): ?>
                <span class="category-btn"><?php echo htmlspecialchars($cat['name']); ?></span>
            <?php endwhile; ?>
        </div>
        ...
        <h3 style="margin-top: 30px; margin-bottom: 15px;">Available from Sellers:</h3>
                ...
                <?php while ($seller_info = $product_sellers->fetch_assoc()): ?>
                    <div style="background: #f9f9f9; padding: 15px; border-radius: 8px; border: 1px solid #ddd;">
                        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px;">
                            ...
                            <div style="text-align: right;">
                                ...
                                <div style="color: #666; font-size: 0.9rem;">
                                    Stock: <?php echo $seller_info['seller_stock'] ?? $seller_info['stock'] ?? 0; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <?php elseif (!isLoggedIn()): ?>
                            <a href="login.php" class="btn btn-secondary" style="margin-top: 10px;">Login to Buy</a>
                        <?php else: ?>
                            <p style="color: red; margin-top: 10px;">Out of Stock</p>
                        <?php endif; ?>
                    </div>
                <?php endwhile; ?>
            </div>
